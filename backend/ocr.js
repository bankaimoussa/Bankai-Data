...
- daName: اسم صاحب البطاقة، ثلاث كلمات بس (الاسم الأول + اسم الأب + اسم الجد)، بحروف إنجليزية (Latin letters) فقط. لو البطاقة فيها نسخة إنجليزية مطبوعة للاسم، انسخ أول 3 كلمات منها زي ما هي بالظبط. لو مفيش نسخة إنجليزية مطبوعة في الصورة، حوّل أول 3 كلمات من الاسم العربي المكتوب إلى Transliteration إنجليزي قياسي (مثال: "محمد أحمد علي حسن" → "Mohamed Ahmed Ali")، بحروف إنجليزية فقط بدون أي حرف عربي، وابدأ كل كلمة بحرف كبير.
...
تعليمات خاصة بكل حقل:
- daName: اسم صاحب الرخصة، ثلاث كلمات بس (الاسم الأول + اسم الأب + اسم الجد)، بحروف إنجليزية (Latin letters) فقط. رخص القيادة المصرية غالبًا بتحتوي على اسم صاحب الرخصة مطبوع بالإنجليزي في مكان قريب من الاسم العربي أو أسفله — لو موجود، انسخ أول 3 كلمات منه زي ما هي مكتوبة بالظبط (بدون ترجمة من عندك). لو مفيش نسخة إنجليزية مطبوعة في الصورة خالص، حوّل أول 3 كلمات من الاسم العربي إلى Transliteration إنجليزي قياسي بحروف إنجليزية فقط، وابدأ كل كلمة بحرف كبير. النتيجة النهائية لازم تكون 3 كلمات بالإنجليزي فقط بدون أي حرف عربي.
- nationalId: مهم جدًا: في رخصة القيادة المصرية، الرقم المطبوع في خانة "رقم الرخصة" هو نفسه الرقم القومي لصاحب الرخصة (14 رقم). اقرأ هذا الرقم واكتبه هنا في هذا الحقل بالظبط.
...
async function extractFromImage(docType, base64Image) {
  ...
  const body = {
    ...
    options: {
      ...
      top_p: 0.9,
      top_k: 40,
      // بادجت متوسط (560) بيوازن بين دقة القراءة وسرعة الاستجابة
